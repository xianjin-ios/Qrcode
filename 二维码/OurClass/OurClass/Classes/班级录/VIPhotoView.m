...
- (void)setupGestureRecognizer
{
    ...
    [_containerView addGestureRecognizer:singleRecognizer];
    ...
    [_containerView addGestureRecognizer:doubleRecognizer];
...
- (void)SingleTap:(UITapGestureRecognizer *)recognizer{
    UIView *view = [MyAppDelegate.window viewWithTag:1101];
    UIView *view1 = [MyAppDelegate.window viewWithTag:1102];
    if(view){
